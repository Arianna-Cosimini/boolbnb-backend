<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta eliminato il tuo account, tutti i dati verranno persi. Prima di eliminare il tuo account, scarica tutte le info e le risorse che vorresti mantenere.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __("Una volta eliminato il tuo account, tutti i dati verranno persi. Inserisci la tua password per confermare l'eliminazione dell'account.") }}
                    </p>
                </div>
